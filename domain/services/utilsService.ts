...
export class UtilsService implements IService {
    ...
    public static randomString(length = 13) {
        let text = "";
    ...
    public static generateCNPJ(formatting: IFormattingOptions = { withDashs: true, withSlashs: true, withDots: true }): string {
        let n: number = 9;
    ...
    // tslint:disable-next-line:max-line-length
    public static generateCPF(formatting: IFormattingOptions =  {withDashs: true, withSlashs: true, withDots: true }): string {
        let n: number = 9;
        let n1: number = this.randomNumber(n);
        let n2: number = this.randomNumber(n);
        let n3: number = this.randomNumber(n);
